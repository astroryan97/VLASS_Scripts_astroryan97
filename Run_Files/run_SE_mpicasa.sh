...
xvfb-run -a \
/usr/local/bin/CASA/casa-6.5.4-9-pipeline-2023.1.1.8/bin/mpicasa -n 16 \
/usr/local/bin/CASA/casa-6.5.4-9-pipeline-2023.1.1.8/bin/casa \
--pipeline --nogui --nologger -c command_script.py